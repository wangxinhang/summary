...
namespace SBJYJCMIS.BLL
{
    public class Permission
    {
        ...
        {
            return dal.PermissionGetListByXuserIdOperationIdResourceIdResourceTypeId(xuserId, operationId, resourceId, resourceTypeId);
        }
        ...
        {
            return dal.AppMenuGetPermissionList(xuserId);
        }
