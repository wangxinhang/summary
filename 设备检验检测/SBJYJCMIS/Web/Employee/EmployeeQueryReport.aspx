<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="EmployeeQueryReport.aspx.cs" Inherits="SBJYJCMIS.Web.EmployeeQueryReport" %>
...
<script type="text/javascript">
    ...
    function InitialReport() {
        var p = $("#ReportPanel");
        var c = document.body;
        var h = parent.document.body.exportWindow.height - 39;
    ...
    function ResizeReport() {
        var p = $("#ReportPanel");
        var c = document.body;
        var h = parent.document.body.opWhite.height - 39;
