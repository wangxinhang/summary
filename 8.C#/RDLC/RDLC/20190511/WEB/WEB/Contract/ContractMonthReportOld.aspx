<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractMonthReportOld.aspx.cs"
    Inherits="SBJYJCMIS.Web.ContractMonthReportOld" %>
...
<head id="Head1" runat="server">
    ...
    function InitialReport() {
        ...
        SzdwCommon.showReportExportBarThree(p, mc);
    }
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="ReportPanel" style="border: 0px; text-align: center;">
            <rsweb:ReportViewer ID="rptQuery" runat="server" Font-Names="Verdana"
                Font-Size="8pt" ProcessingMode="Remote" WaitMessageFont-Names="Verdana"
                WaitMessageFont-Size="14pt" Width="100%" InteractiveDeviceInfos="(集合)">
                <ServerReport ReportPath="/DepartmentByMonth/DepartmentByMonth" />
            </rsweb:ReportViewer>
        </div>
    </form>
</body>
