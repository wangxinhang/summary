...
/****** Object:  StoredProcedure [dbo].[proContractSubtotalGetListNew]    Script Date: 06/01/2019 13:48:09 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	合同分类统计
-- =============================================
CREATE PROCEDURE [dbo].[proContractSubtotalGetListNew]
...
BEGIN
	...
	SET @SqlRecordSet='
		...
		TSFX AS(
		SELECT  GrandDepartmentID,GrandDepartment,ParentDepartmentID,ParentDepartment,DepartmentID,Department,Month,
		        SUM(Amount) AS Amount
		 from TUFF
		GROUP BY GrandDepartmentID,GrandDepartment,ParentDepartmentID,ParentDepartment,DepartmentID,Department,Month
		)
		'		   	
	
	--不分页查询语句--
	SET @SqlUnPaged='SELECT * FROM TSFX '
