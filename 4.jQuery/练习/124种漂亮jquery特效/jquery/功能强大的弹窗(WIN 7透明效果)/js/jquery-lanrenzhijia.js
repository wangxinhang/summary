/*
 * lanrenzhijia - jQuery Plugin (v3.51)
 * Copyright 2010, Christian Goldbach
 * Dual licensed under the MIT or GPL Version 2 licenses.
 * 
 * Project Website:
 * http://www.soyos.net/lanrenzhijia-jquery.html
 * http://www.soyos.net
 *
 *
 *
  ...
  $.fn.extend({ 
    ...
    lanrenzhijia: function(options) {
      ...
      if ($WindowAllwaysRegistered == true) {
        Window = $(this).find(".lanrenzhijia");
        $(this).find(".lanrenzhijia").css('display', 'block'); 
        $(".lanrenzhijia").removeClass('active');
        if (Window.hasClass('lanrenzhijia')) Window.addClass('active');
        if (($('body').data('lanrenzhijiaMaxZIndex')) == null) {
          $('body').data( 'lanrenzhijiaMaxZIndex' , Window.css('z-index'));
        }
        i = $('body').data('lanrenzhijiaMaxZIndex');
        i++;
      ...
      return this.each(function() {
        ...
        //Window Objects ------------------------------------------------------
        var Window          = $(this).find(".lanrenzhijia");
        ...
        Window.draggable({
          ...
          start: function() {
            FocusWindow(Window);
            $(".lanrenzhijia").find('#iframeHelper').css({'display': 'block'});
            $(".lanrenzhijia").removeClass('active');
            $(this).addClass('active');
            $('body').data( 'lanrenzhijiaMaxZIndex' , $(this).css('z-index'));
          },
          drag: function() {
          ...
          stop: function() {
            ...
            $(".lanrenzhijia").find('#iframeHelper').css({'display': 'none'});
          }
        });
      }
